 ...
 */
public class HiveForOracleJdbcSqlHelper extends BaseJdbcSqlHelper {
    public HiveForOracleJdbcSqlHelper(Connection conn) {
        super(conn);
    }
    ...
    public String getDbType() {
        return DBType.HIVE_FOR_ORACLE.getValue();
    }
}
