 ...
 */
public class ImpalaForMysqlJdbcSqlHelper extends BaseJdbcSqlHelper {
    public ImpalaForMysqlJdbcSqlHelper(Connection conn) {
        super(conn);
    }
    ...
    public String getDbType() {
        return DBType.IMPALA_FOR_MYSQL.getValue();
    }
}
