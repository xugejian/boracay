...
public enum ErrorCode {
    ...
    ERROR_000017 ("服务停用", "000017"),
    ERROR_000018 ("运行队列已满且未开启等待队列", "000018"),
    ERROR_000019 ("服务类型不支持", "000019"),
    ERROR_000020 ("请求日期不在允许的日期窗口内", "000020"),
    ERROR_000021 ("请求时间不在允许的时间窗口内", "000021"),
    ERROR_000099 ("其他错误", "000099"),
    //注：1开头为交互查询相关错误码
    //注：2开头为模型相关错误码
    ERROR_200001 ("模型接口无响应", "200001"),
    ERROR_200002 ("模型名称不存在", "200002"),
    ERROR_200003 ("模型参数错误", "200003"),
    ERROR_200004 ("模型调用其他异常", "200004"),
    ERROR_200005 ("模型不支持该类型", "200005");
