...
set feedback off
set define off
prompt Disabling triggers for T_GF_APPLICATION...
alter table T_GF_APPLICATION disable all triggers;
prompt Disabling triggers for T_GF_AUTH_RIGHT...
alter table T_GF_AUTH_RIGHT disable all triggers;
prompt Disabling triggers for T_GF_DICT...
alter table T_GF_DICT disable all triggers;
prompt Disabling triggers for T_GF_DICT_TYPE...
alter table T_GF_DICT_TYPE disable all triggers;
prompt Disabling triggers for T_GF_EMPLOYEE...
alter table T_GF_EMPLOYEE disable all triggers;
prompt Disabling triggers for T_GF_FUNCATION...
alter table T_GF_FUNCATION disable all triggers;
prompt Disabling triggers for T_GF_LOGINUSER...
alter table T_GF_LOGINUSER disable all triggers;
prompt Disabling triggers for T_GF_MENU...
alter table T_GF_MENU disable all triggers;
prompt Disabling triggers for T_GF_NEXTID...
alter table T_GF_NEXTID disable all triggers;
prompt Disabling triggers for T_GF_ORG...
alter table T_GF_ORG disable all triggers;
prompt Disabling triggers for T_GF_QUARTZ...
alter table T_GF_QUARTZ disable all triggers;
prompt Disabling triggers for T_GF_RES_AUTH...
alter table T_GF_RES_AUTH disable all triggers;
prompt Disabling triggers for T_GF_ROLE...
alter table T_GF_ROLE disable all triggers;
prompt Disabling triggers for T_GF_SCHD_JOB...
alter table T_GF_SCHD_JOB disable all triggers;
prompt Disabling triggers for T_GF_TASK_POOL...
alter table T_GF_TASK_POOL disable all triggers;
prompt Deleting T_GF_TASK_POOL...
delete from T_GF_TASK_POOL;
commit;
prompt Deleting T_GF_SCHD_JOB...
delete from T_GF_SCHD_JOB;
commit;
prompt Deleting T_GF_ROLE...
delete from T_GF_ROLE;
commit;
prompt Deleting T_GF_RES_AUTH...
delete from T_GF_RES_AUTH;
commit;
prompt Deleting T_GF_QUARTZ...
delete from T_GF_QUARTZ;
commit;
prompt Deleting T_GF_ORG...
delete from T_GF_ORG;
commit;
prompt Deleting T_GF_NEXTID...
delete from T_GF_NEXTID;
commit;
prompt Deleting T_GF_MENU...
delete from T_GF_MENU;
commit;
prompt Deleting T_GF_LOGINUSER...
delete from T_GF_LOGINUSER;
commit;
prompt Deleting T_GF_FUNCATION...
delete from T_GF_FUNCATION;
commit;
prompt Deleting T_GF_EMPLOYEE...
delete from T_GF_EMPLOYEE;
commit;
prompt Deleting T_GF_DICT_TYPE...
delete from T_GF_DICT_TYPE;
commit;
prompt Deleting T_GF_DICT...
delete from T_GF_DICT;
commit;
prompt Deleting T_GF_AUTH_RIGHT...
delete from T_GF_AUTH_RIGHT;
commit;
prompt Deleting T_GF_APPLICATION...
delete from T_GF_APPLICATION;
commit;
...
insert into T_GF_NEXTID (seq_type, next_id, last_time)
values ('GF_RES_AUTH', 13000, to_date('05-06-2017 20:12:49', 'dd-mm-yyyy hh24:mi:ss'));
insert into T_GF_NEXTID (seq_type, next_id, last_time)
values ('LOG_ID', 175300, to_date('20-06-2017 14:20:30', 'dd-mm-yyyy hh24:mi:ss'));
insert into T_GF_NEXTID (seq_type, next_id, last_time)
...
values ('1', '致宇信息', '000001', 1, '.1.', 'undefined', '上海', null, null, null, null, null, null, null, 'default', '0');
commit;
prompt 1 records loaded
...
values ('127631', 'ADMIN', 'role', '105001', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127641', 'ADMIN', 'role', '107001', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127651', 'ADMIN', 'role', '100051', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127661', 'ADMIN', 'role', '100061', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127671', 'ADMIN', 'role', '100071', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127681', 'ADMIN', 'role', '100161', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127691', 'ADMIN', 'role', '100111', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127701', 'ADMIN', 'role', '106001', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127711', 'ADMIN', 'role', '100141', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127721', 'ADMIN', 'role', '100151', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127731', 'ADMIN', 'role', '108001', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127741', 'ADMIN', 'role', '100091', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127751', 'ADMIN', 'role', '100171', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127761', 'ADMIN', 'role', '100131', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127771', 'ADMIN', 'role', '100181', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127781', 'ADMIN', 'role', '100311', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127791', 'ADMIN', 'role', '100191', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127801', 'ADMIN', 'role', '100201', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127811', 'ADMIN', 'role', '100291', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127821', 'ADMIN', 'role', '100301', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127831', 'ADMIN', 'role', '100241', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127841', 'ADMIN', 'role', '100261', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127851', 'ADMIN', 'role', '100271', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127861', 'ADMIN', 'role', '101011', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127871', 'ADMIN', 'role', '1102', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127881', 'ADMIN', 'role', '1103', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127891', 'ADMIN', 'role', '1104', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127901', 'ADMIN', 'role', '1105', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127911', 'ADMIN', 'role', '109011', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127921', 'ADMIN', 'role', '1107', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
values ('127931', 'ADMIN', 'role', '101002', 'default', 'menu');
insert into T_GF_RES_AUTH (id, auth_id, auth_type, res_id, app_id, res_type)
...
prompt Table is empty
prompt Enabling triggers for T_GF_APPLICATION...
alter table T_GF_APPLICATION enable all triggers;
prompt Enabling triggers for T_GF_AUTH_RIGHT...
alter table T_GF_AUTH_RIGHT enable all triggers;
prompt Enabling triggers for T_GF_DICT...
alter table T_GF_DICT enable all triggers;
prompt Enabling triggers for T_GF_DICT_TYPE...
alter table T_GF_DICT_TYPE enable all triggers;
prompt Enabling triggers for T_GF_EMPLOYEE...
alter table T_GF_EMPLOYEE enable all triggers;
prompt Enabling triggers for T_GF_FUNCATION...
alter table T_GF_FUNCATION enable all triggers;
prompt Enabling triggers for T_GF_LOGINUSER...
alter table T_GF_LOGINUSER enable all triggers;
prompt Enabling triggers for T_GF_MENU...
alter table T_GF_MENU enable all triggers;
prompt Enabling triggers for T_GF_NEXTID...
alter table T_GF_NEXTID enable all triggers;
prompt Enabling triggers for T_GF_ORG...
alter table T_GF_ORG enable all triggers;
prompt Enabling triggers for T_GF_QUARTZ...
alter table T_GF_QUARTZ enable all triggers;
prompt Enabling triggers for T_GF_RES_AUTH...
alter table T_GF_RES_AUTH enable all triggers;
prompt Enabling triggers for T_GF_ROLE...
alter table T_GF_ROLE enable all triggers;
prompt Enabling triggers for T_GF_SCHD_JOB...
alter table T_GF_SCHD_JOB enable all triggers;
prompt Enabling triggers for T_GF_TASK_POOL...
alter table T_GF_TASK_POOL enable all triggers;
set feedback on
set define on
prompt Done.
