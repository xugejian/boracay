...
public class ESUtil {
    ...
    private static Map<String, ElasticSearchConnectionPoolFactory> dataSourcePool = new HashMap<> ();

    public static synchronized ElasticSearchConnectionPoolFactory getDataSource(ELSearchDatasource datasource) {
